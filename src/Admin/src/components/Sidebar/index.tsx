        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/admin/dashboard' ||
                      ...
                      >
                        ...
                        <NavLink
                          to="/admin/dashboard"
                          className={({ isActive }) =>
                            'group relative flex items-center gap-2.5 rounded-md pr-24 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                            (isActive && '!text-white')
                          }
                        >
                          Dashboard
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/admin/manage-product' || pathname.includes('product')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/admin/manage-product' ||
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/admin/manage-coupon' || pathname.includes('coupon')
                }
              >
                {(handleClick, open) => {
                  return (
